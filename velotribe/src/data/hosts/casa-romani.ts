...
export const casaRomaniBase = {
  ...
  description: {
    en: "Casa Romaní is a fully renovated holiday home in the quiet village of Camós, nestled among fields with views towards the Pyrenees. The house has a covered terrace, barbecue area, and a private garden — ideal for unwinding after a long day in the saddle. The interior is comfortable and practical, with a fully equipped self-catering kitchen, spacious living room, and multiple bedrooms to sleep your whole group.",
    es: "Casa Romaní es una casa de vacaciones totalmente renovada en el tranquilo pueblo de Camós, rodeada de campos con vistas a los Pirineos. La casa dispone de terraza cubierta, zona de barbacoa y jardín privado — ideal para descansar tras una larga jornada sobre la bicicleta. El interior es cómodo y práctico, con cocina equipada de autoservicio, amplio salón y varias habitaciones para alojar a todo el grupo.",
    ca: "Casa Romaní és una casa de vacances totalment renovada al tranquil poble de Camós, envoltada de camps amb vistes als Pirineus. La casa disposa de terrassa coberta, zona de barbacoa i jardí privat — ideal per descansar després d'una llarga jornada sobre la bicicleta. L'interior és còmode i pràctic, amb cuina equipada d'autoservei, sala d'estar àmplia i diverses habitacions per allotjar tot el grup.",
  },
  ...
  seoTitle: {
    en: 'Casa Romaní — Cyclist stay near Lake Banyoles | VeloTribe',
    es: 'Casa Romaní — Alojamiento ciclista cerca del lago de Banyoles | VeloTribe',
    ca: 'Casa Romaní — Allotjament ciclista prop del llac de Banyoles | VeloTribe',
  },
